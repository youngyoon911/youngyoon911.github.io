...
My research focuses on **generative modeling**, particularly video diffusion and flow models. Recently, I have worked on motion customization, proposing an optimization framework robust to the content leakage problem. Looking ahead, I aim to leverage the rich representations learned by generative models to build persistent world models that enable interactive, world-consistent, and long-horizon generation.
